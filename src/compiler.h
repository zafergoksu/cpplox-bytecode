...
private:
    ...
    std::unordered_map<token::TokenType, ParseRule> m_rules{
        ...
        {token::TokenType::TOKEN_BANG_EQUAL, {std::nullopt, std::bind(&Compiler::binary, this), Precedence::PREC_EQUALITY}},
        {token::TokenType::TOKEN_EQUAL, {std::nullopt, std::nullopt, Precedence::PREC_NONE}},
        {token::TokenType::TOKEN_EQUAL_EQUAL, {std::nullopt, std::bind(&Compiler::binary, this), Precedence::PREC_EQUALITY}},
        {token::TokenType::TOKEN_GREATER, {std::nullopt, std::bind(&Compiler::binary, this), Precedence::PREC_COMPARISON}},
